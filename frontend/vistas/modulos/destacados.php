			...
			<li class="col-xs-12">
				...
				<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
					...
					<figure>
						...
						<a href="#" class="pixelProducto"><img src="http://localhost/ecommerce/backend/vistas/img/productos/accesorios/accesorio04.jpg" class="img-responsive"></a>
			...
			<li class="col-xs-12">
				...
				<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
					...
					<figure>
						...
						<a href="#" class="pixelProducto"><img src="http://localhost/ecommerce/backend/vistas/img/productos/accesorios/accesorio03.jpg" class="img-responsive"></a>
			...
			<li class="col-xs-12">
				...
				<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
					...
					<figure>
						...
						<a href="#" class="pixelProducto"><img src="http://localhost/ecommerce/backend/vistas/img/productos/accesorios/accesorio02.jpg" class="img-responsive"></a>
			...
			<li class="col-xs-12">
				...
				<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
					...
					<figure>
						...
						<a href="#" class="pixelProducto"><img src="http://localhost/ecommerce/backend/vistas/img/productos/accesorios/accesorio01.jpg" class="img-responsive"></a>
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<div class="col-xs-6 enlaces">
					...
					<div class="btn-group pull-right">
						...
						<button type="button" class="btn btn-default btn-xs agregarCarrito" idProducto="404" imagen="http://localhost/ecommerce/backend/vistas/img/productos/cursos/curso05.jpg" titulo="Curso de Bootstrap" precio="10" tipo="virtual" peso="0"  data-toggle="tooltip" title="Agregar al carrito de compras">
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<div class="col-xs-6 enlaces">
					...
					<div class="btn-group pull-right">
						...
						<button type="button" class="btn btn-default btn-xs agregarCarrito" idProducto="404" imagen="http://localhost/ecommerce/backend/vistas/img/productos/cursos/curso04.jpg" titulo="Curso de Canvas y Javascript" precio="10" tipo="virtual" peso="0"  data-toggle="tooltip" title="Agregar al carrito de compras">
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<div class="col-xs-6 enlaces">
					...
					<div class="btn-group pull-right">
						...
						<button type="button" class="btn btn-default btn-xs agregarCarrito" idProducto="404" imagen="http://localhost/ecommerce/backend/vistas/img/productos/cursos/curso02.jpg" titulo="Aprende Javascript desde cero" precio="10" tipo="virtual" peso="0"  data-toggle="tooltip" title="Agregar al carrito de compras">
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<div class="col-xs-6 enlaces">
					...
					<div class="btn-group pull-right">
						...
						<button type="button" class="btn btn-default btn-xs agregarCarrito" idProducto="404" imagen="http://localhost/ecommerce/backend/vistas/img/productos/cursos/curso03.jpg" titulo="Curso de jQuery" precio="10" tipo="virtual" peso="0"  data-toggle="tooltip" title="Agregar al carrito de compras">
