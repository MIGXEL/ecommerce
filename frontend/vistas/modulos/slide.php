	...
	<div class="row">
		...
		<ul>
			...
			<li>
				...
				<img src="http://localhost/ecommerce/backend/vistas/img/slide/default/back_default.jpg">

				<div class="slideOpciones slideOpcion1">
					
					<img class="imgProducto" src="http://localhost/ecommerce/backend/vistas/img/slide/slide1/calzado.png" style="top:15%; right:10%; width:45%">
			...
			<li>
				...
				<img src="http://localhost/ecommerce/backend/vistas/img/slide/slide3/fondo2.jpg">
			...
			<li>
				...
				<img src="http://localhost/ecommerce/backend/vistas/img/slide/slide4/fondo3.jpg">
